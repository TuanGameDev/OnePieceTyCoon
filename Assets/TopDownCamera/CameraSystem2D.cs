...
namespace CodeMonkey.CameraSystem
{
    public class CameraSystem2D : MonoBehaviour
    {
        ...
        [SerializeField]
        private float orthographicSizeMin = 10;

        [SerializeField]
        private float orthographicSizeMax = 50;
...
;        }
        ...
        private void HandleCameraZoom_OrthographicSize()
        {
            ...
            cinemachineVirtualCamera.m_Lens.OrthographicSize =
                Mathf.Lerp(cinemachineVirtualCamera.m_Lens.OrthographicSize, targetOrthographicSize,
